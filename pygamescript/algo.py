...
class CurveGenerate:
    ...
    def BezierCurve(startX, startY, endX, endY, duration):
        ...
        number_list: int = int(math.dist((startX, startY), (endX, endY)) / (1.5 * duration))
        ...
        return BezierTrajectory.trackArray(start=(startX, startY), end=(endX, endY), numberList=number_list, le=le,
